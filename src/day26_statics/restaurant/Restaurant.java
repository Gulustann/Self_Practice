...
public class Restaurant {
    ...
    public void hireServers(Server[] servers) {
        this.servers.addAll(Arrays.asList(servers));//this.servers calls instance variable(ArrayList) instead of local variable
    }
    ...
    public void hireChefs(Chef[] chefs) {
        this.chefs.addAll(Arrays.asList(chefs));//this.chefs calls instance variable(ArrayList) instead of local variable
    }
